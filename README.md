...
You can also find Termux configuration files on Android, in termux directory.

## License

This repository is licensed under WTFPL. You can view full license [here](https://github.com/enindu/dotfiles/blob/master/LICENSE.md).
